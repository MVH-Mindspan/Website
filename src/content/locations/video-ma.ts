...
export const videoMassachusettsDetail: LocationDetail = {
  hero: {
    ...
    title:
      "See your neurologist from home, anywhere in Massachusetts.",
    lead:
      "Specialty memory care, on your phone, tablet, or computer. No driving, no waiting room, no 18-month wait. The same unhurried visits we give patients in our Danvers clinic, from wherever you’re most comfortable in the Commonwealth.",
  ...
  services: {
    ...
    cards: [
      ...
      },
      {
        ...
        body:
          "We order labs, biomarker panels, and imaging at convenient nearby sites in Massachusetts. Results come back to your Mindspan team and we walk you through them on video.",
        icon: "grid",
      },
      {
        id: "network",
        eyebrow: "Mindspan network",
        title: "Care coordinated across the Commonwealth.",
        body:
  ...
  whyChoose: {
    ...
    edge: {
      id: "anywhere-ma",
      eyebrow: "Anywhere in Massachusetts",
      title: "From the Berkshires to the Cape, no driving required.",
      body:
        "If you live anywhere in Massachusetts, we can see you. That includes patients on the North Shore, the South Shore, MetroWest, the Pioneer Valley, and the Cape and Islands.",
      bullets: [
        "First visits typically within two to three weeks",
        "Family members can join from anywhere",
        "Avoid the drive when mobility or weather make it hard",
      ],
      icon: "bullseye",
    },
    closing:
  ...
  careTeam: {
    intro: {
      ...
      title: "Massachusetts patients see the Danvers team on video.",
      lead:
        "The same neurologist who would see you in our Danvers clinic sees you on video. No rotating telehealth pool, no anonymous network.",
    },
    providers: [
      {
        name: "Timothy R. Kelliher, MD",
        role: "Founding Neurologist, Mindspan Danvers",
        image: "/assets/tim-kelliher.webp",
        imageAlt:
          "Dr. Timothy R. Kelliher, MD, Founding Neurologist at Mindspan Danvers",
        specialties: [
  ...
  inPersonClinics: {
    intro: {
      ...
      title: "We have a clinic on Boston’s North Shore.",
      lead:
        "Some visits are easier in person, especially first appointments and certain assessments. If you’re closer to the North Shore or just prefer face-to-face, our Danvers clinic is open and accepting new patients.",
    },
    clinics: [
      {
        city: "Danvers",
        ...
        blurb:
          "Specialty memory care on the North Shore. First visits typically within two to three weeks, with diagnostics, imaging, and biomarkers ready at the first appointment.",
        cta: { label: "Visit our Danvers clinic", href: "/locations/danvers" },
      },
    ],
  },
    ...
    items: [
      {
        ...
        body:
          "You’ve been noticing changes, making calls, and being told to wait. Bring your loved one to a video visit, you can both join from the same room, or different rooms in the same house, or even different cities. We’ll take it from here together.",
  ...
  finalCta: {
    ...
    lead:
      "See a specialist in weeks, not months or years. By video from your living room, or in person on the North Shore.",
    primary: { label: "Book a video visit", href: BOOKING_HREF },
    secondary: { label: "Visit our Danvers clinic", href: "/locations/danvers" },
    signature: "With care, the Mindspan Massachusetts team",
  },
};
