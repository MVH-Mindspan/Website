...
const EXISTING_HREF = "https://oncehub.com/mindspan_irvine";

export const irvineDetail: LocationDetail = {
  hero: {
    eyebrow: "Irvine, California",
    title:
      "Alzheimer’s & dementia care in Orange County. Act early. Preserve what matters most.",
    lead:
      "Our Irvine clinic offers specialized memory care that goes beyond standard neurology, from early MCI detection to advanced Alzheimer’s treatments and clinical trials. Skip the typical 18+ month wait to see a neurologist.",
    location: "16100 Sand Canyon Ave, Suite 240 · Irvine, CA 92618",
    availability: {
  ...
  services: {
    intro: {
      ...
      title: "Core services at our Irvine clinic.",
      lead:
        "Act early to help preserve your loved one’s independence, identity, and quality of life. Our Irvine team detects early, treats comprehensively, and connects you to the latest science, all under one roof.",
    },
    cards: [
      {
        id: "early-screening",
      ...
      },
      {
        ...
        body:
          "Access to FDA-approved anti-amyloid therapies and cutting-edge clinical trials at our Irvine clinic.",
        icon: "bullseye",
      },
      {
        id: "precision",
      ...
      },
      {
        ...
        title: "Care coordinated across Orange County.",
        body:
          "Seamless coordination with specialists, caregivers, and care teams throughout Orange County and greater Los Angeles.",
        icon: "chat",
      },
    ],
  },
  ...
  stages: {
    ...
    items: [
      ...
      },
      {
        ...
        title: "Dementia",
        body:
          "A progressive decline affecting daily function. Mindspan Irvine provides advanced therapies, ongoing clinical care, and access to the latest science for all stages.",
  ...
  whyChoose: {
    intro: {
      ...
      title: "Why choose a specialized memory center in Orange County?",
      lead:
        "General neurologists see patients with dozens of conditions. At Mindspan Irvine, our team specializes exclusively in memory and cognitive disorders, giving you access to deeper expertise, advanced diagnostics, FDA-approved therapies, clinical trials, and a clinical care team that stays with you from first assessment through ongoing treatment.",
      image: "/assets/digital-brain.jpg",
      imageAlt:
        "Advanced brain imaging used for early-stage cognitive diagnostics at Mindspan Irvine",
    },
    core: {
      id: "subspecialty",
    ...
    edge: {
      ...
      body:
        "Today, many patients wait months to see a specialist. By the time they are evaluated, they may already be outside the window where treatment can meaningfully slow the disease. Our Irvine clinic prioritizes rapid access so treatment can begin while it is most effective.",
      bullets: [
    ...
    closing:
      "Our Irvine clinic moves quickly, using advanced diagnostics, biomarkers, imaging, and AI-supported tools, to identify disease early and start the right treatment. Act early to help preserve your loved one’s independence, identity, and quality of life.",
    cta: { label: "Book a visit at our Irvine clinic", href: BOOKING_HREF },
  },

  contact: {
    address: "16100 Sand Canyon Ave, Suite 240, Irvine, CA 92618",
    mapEmbedSrc:
      "https://www.openstreetmap.org/export/embed.html?bbox=-117.755,33.645,-117.725,33.665&layer=mapnik&marker=33.653700,-117.745600",
    phone: "(949) 990-6320",
    phoneHref: "tel:+19499906320",
    email: "PracticeManager@Mindspan.co",
    emailHref:
      "mailto:PracticeManager@Mindspan.co?subject=Mindspan%20Irvine%20patient%20enquiry",
  ...
  finalCta: {
    ...
    title: "Talk with us at our Irvine clinic today.",
    lead:
    ...
    secondary: { label: "Call (949) 990-6320", href: "tel:+19499906320" },
    signature: "With care, the Mindspan Irvine team",
  },
};
