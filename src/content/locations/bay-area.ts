...
export const bayAreaDetail: LocationDetail = {
  ...
  provider: {
    ...
    bio:
      "Dr. Noor Sachdev is a board-certified neurologist in San Jose, California, with expertise in Alzheimer\u2019s disease and dementia. He is fellowship-trained in clinical neurophysiology at Columbia and brings more than fifteen years of clinical experience. At Mindspan, he is at the forefront of cutting-edge diagnostics and therapeutics, participating in multiple clinical trials and collaborating with cognitive clinics at Stanford, UCSF, ALZ-NET, and Sutter Health.",
    specialties: [
    ...
    education: [
      "BS, University of Southern California (Psychobiology, cum laude)",
