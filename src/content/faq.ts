...
export const faq: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Yes. We bill Medicare and most major commercial plans. If your loved one has a dementia diagnosis and is on Original Medicare (not Medicare Advantage or PACE), there may be additional Medicare-supported benefits available; we confirm eligibility during onboarding.",
  },
  {
    id: "video",
