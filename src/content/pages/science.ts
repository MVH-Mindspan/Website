...
const technologyCards: TechCard[] = [
  {
    ...
    body:
      "Mindy walks you through a 10-minute cognitive assessment, the Memory Impairment Screen (a brief memory check), the Functional Assessment Staging Tool (a snapshot of daily functioning), and intake at your own pace, then sends a structured summary to your care team. The same assessments your neurologist would administer, ready before your visit so the time together can focus on you.",
    icon: "chat",
  },
  {
    id: "digital-twin",
