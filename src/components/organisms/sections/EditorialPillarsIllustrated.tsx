...
export type IllustratedPillar = {
  kicker: string;
  title: string;
  body: string;
  illustration: JourneyIllustrationKind;
};

export function EditorialPillarsIllustrated({
  pillars,
  intro,
}: {
  pillars: readonly IllustratedPillar[];
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  >
                    <JourneyIllustration kind={p.illustration} />
                  </div>
                </div>
